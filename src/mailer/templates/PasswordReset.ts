...
<p>If this link somehow does not work, you have to request a new password reset on the CreativIT website again.</p>
...
If this link somehow does not work, you have to request a new password reset on the CreativIT website again.
